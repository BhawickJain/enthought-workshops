...
m = MatrixPlot(G, node_grouping="gender", node_color="gender")
m.draw()
# MatrixPlot.matrix_group(G, group_by="gender")
```
...
```{python slideshow={'slide_type': 'subslide'}, tags=c()}
from nxviz.plots import CircosPlot

c = CircosPlot(G, group_by="gender", node_color="gender")
c.draw()
